...
>
  ...
  {/if}
  <div
    class="flex flex-col items-center gap-4 rounded-lg bg-gray-900/50 p-4 text-center  backdrop-blur-sm"
  >
    ...
    <p class="text-gray-300">A simple price checker for your favorite products</p>
    <p class="mt-2 text-sm text-gray-300">
      Powered by <a
        href="https://codepiercer.org"
        target="_blank"
        class="font-bold tracking-wider text-red-500">CODEPIERCER</a
      >
    </p>
    <button
      type="button"
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" class="mr-2 w-6"
        ><path
          fill="#FFC107"
